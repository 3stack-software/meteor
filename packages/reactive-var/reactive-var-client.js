import { shallowRef, triggerRef } from '@vue/runtime-dom';
/*
...
export function ReactiveVar (initialValue, equalsFunc) {
  ...
  this._ref = shallowRef(initialValue);
...
Object.defineProperties(ReactiveVar.prototype, {
  curValue: {
    get() {
      return this._ref._rawValue;
    }
  },
  dep: {
    get() {
      throw new Error('ReactiveVar.dep is unavailable')
    }
  },
});
/**
...
ReactiveVar.prototype.set = function (newValue) {
  var oldValue = this._ref._rawValue;
...
ReactiveVar.prototype._numListeners = function() {
  console.warn('ReactiveVar._numListeners is unvailable')
};
